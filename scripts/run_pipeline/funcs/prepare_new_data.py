...
# Pathing
from path.get_paths import addNewDatasetPaths
...
from misc.misc_fns import loadData
...
def main():
    ...
    parser.add_argument("--usecols", required=True,
                        help='JSON list, e.g., ["SMILES", "pIC50"]')
    parser.add_argument("--rename", default="{}",
                        help='JSON dict, e.g., {"old_column_name": "new_column_name"}')
